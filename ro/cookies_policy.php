            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-contents">
                        <h4 class="breadcrumb-contents-title"> Politica privind Fisiere Cookies </h4>
                        <ul class="breadcrumb-contents-list list-style-none">
                            <li class="breadcrumb-contents-list-item"> <a href="index.php" class="breadcrumb-contents-list-item-link"> Acasa </a> </li>
                            <li class="breadcrumb-contents-list-item"> Politica privind Fisiere Cookies </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="section-title center-text">
                    ...
                    Un „Internet Cookie” (termen cunoscut si sub denumirea de „browser cookie” sau „HTTP
                    cookie” ori „cookie”) reprezinta un fisier de mici dimensiuni, format din litere si numere, care va fi stocat
                    pe computerul, terminalul mobil sau pe alte echipamente ale unui utilizator prin intermediul carora se
                    acceseaza internetul.
                    Cookie-urile sunt instalate prin solicitarea emisa de un web-server catre un browser (de ex.:
                    Internet Explorer, Firefox, Chrome). Cookie-urile odata instalate au o durata de existenta determinata,
                    ...
                    Prin acest tip de cookie-uri sunt memorate preferintele utilizatorului acestei pagini de internet,
                    astfel incat setarea din nou a preferintelor in cazul vizitarii ulterioare a paginii de internet nu mai este
                    necesara.

                    b. Cookie-uri de analiza a utilizatorilor
                    Aceste cookie-uri ne informeaza daca un anumit utilizator al paginii de internet a mai
                    vizitat/utilizat aceasta pagina de internet anterior. Aceste cookie-uri sunt utilizate doar in scopuri
                    statistice.
                    c. Cookie-uri pentru geotargetting
                    Aceste cookie-uri sunt utilizate de catre un soft care stabileste tara de provenienta a
                    utilizatorului paginii de internet. Vor fi primite aceleasi reclame indiferent de limba selectata.
                    d. Cookie-uri pentru inregistrare
                    Atunci cand va inregistrati pe acest site, se genereaza cookie-uri care memoreaza acest demers.
                    Serverele utilizeaza aceste cookie-uri pentru a ne arata contul cu care sunteti inregistrat. De asemenea,
                    utilizarea acestor cookie-uri permite sa asociem orice comentariu postat pe pagina de internet cu
                    username-ul contului folosit. In cazul in care nu a fost selectata optiunea „pastreaza-ma inregistrat”,
                    aceste cookie-uri se vor sterge automat la momentul terminarii sesiunii de navigare.
                    e. Cookie-uri pentru publicitate
