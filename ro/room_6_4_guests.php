                    ...
                    <div class="details-left-wrapper">
                        <div class="details-contents bg-white radius-10">
                            <div class="details-contents-header">
                                    <?php if ($numar_poze_room_6 >= 1) : ?>
                                        <div class="single-attraction-two-thumb flex-center">
                                            <a href="assets/images_hotel/rooms/Room_6_4_Guests/room_quadro_1.jpg" class="gallery-popup-two"> <img loading="lazy" src="assets/images_hotel/rooms/Room_6_4_Guests/room_quadro_1-main.jpg" alt="hotel room image"> </a>
                                        </div>
                                    <?php endif; ?>
                                <div class="details-contents-header-flex">
                                    <?php if ($numar_poze_room_6 >= 2) : ?>
                                        <div class="single-attraction-two-thumb">
                                            <a href="assets/images_hotel/rooms/Room_6_4_Guests/room_quadro_2.jpg" class="gallery-popup-two"> <img loading="lazy" src="assets/images_hotel/rooms/Room_6_4_Guests/room_quadro_2-main.jpg" alt="hotel room image"> </a>
                                        </div>
                                    <?php endif; ?>
                                    <?php if ($numar_poze_room_6 >= 3) : ?>
                                        <div class="single-attraction-two-thumb">
                                            <a href="assets/images_hotel/rooms/Room_6_4_Guests/room_quadro_3.jpg" class="gallery-popup-two"> <img loading="lazy" src="assets/images_hotel/rooms/Room_6_4_Guests/room_quadro_3-main.jpg" alt="hotel room image"> </a>
                                        </div>
                                    <?php endif; ?>
                                    <?php for ($i = 4; $i <= $numar_poze_room_6; $i++) : ?>
                                        <div class="single-attraction-two-thumb d-none">
                                            <a href="assets/images_hotel/rooms/Room_6_4_Guests/room_quadro_<?php echo $i; ?>.jpg" class="gallery-popup-two"></a>
                                        </div>
                                    <?php endfor; ?>
                                </div>
                            </div>
