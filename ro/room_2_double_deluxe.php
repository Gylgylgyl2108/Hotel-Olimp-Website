<?php 
$images_folder = '../images_hotel/rooms/Room_2_Double_Deluxe/';
                            ...
                            <div class="details-contents-header">
                                    <?php if ($number_of_photos >= 1) : ?>
                                        <div class="single-attraction-two-thumb flex-center">
                                            <a href="../images_hotel/rooms/Room_2_Double_Deluxe/room_double_deluxe_1.jpg" class="gallery-popup-two"> <img loading="lazy" src="../images_hotel/rooms/Room_2_Double_Deluxe/room_double_deluxe_1-main.jpg" alt="hotel room image"> </a>
                                        </div>
                                    <?php endif; ?>
                                <div class="details-contents-header-flex">
                                    <?php if ($number_of_photos >= 2) : ?>
                                        <div class="single-attraction-two-thumb">
                                            <a href="../images_hotel/rooms/Room_2_Double_Deluxe/room_double_deluxe_2.jpg" class="gallery-popup-two"> <img loading="lazy" src="../images_hotel/rooms/Room_2_Double_Deluxe/room_double_deluxe_2-main.jpg" alt="hotel room image"> </a>
                                        </div>
                                    <?php endif; ?>
                                    <?php if ($number_of_photos >= 3) : ?>
                                        <div class="single-attraction-two-thumb">
                                            <a href="../images_hotel/rooms/Room_2_Double_Deluxe/room_double_deluxe_3.jpg" class="gallery-popup-two"> <img loading="lazy" src="../images_hotel/rooms/Room_2_Double_Deluxe/room_double_deluxe_3-main.jpg" alt="hotel room image"> </a>
                                        </div>
                                    <?php endif; ?>
                                    <?php for ($i = 4; $i <= $number_of_photos; $i++) : ?>
                                        <div class="single-attraction-two-thumb d-none">
                                            <a href="../images_hotel/rooms/Room_2_Double_Deluxe/room_double_deluxe_<?php echo $i; ?>.jpg" class="gallery-popup-two"></a>
                                        </div>
                                    <?php endfor; ?>
                                </div>
                            </div>
